...
{
    public partial class SAB02000 : R_Page
    {
        ...
        private void R_InstantiateDock1(R_InstantiateDockEventArgs args)
        {
            args.TargetPageType = typeof(SAB02001);
        }
        private void R_InstantiateDock2(R_InstantiateDockEventArgs args)
        {
            args.TargetPageType = typeof(SAB02002);
        }
        private void R_InstantiateDock3(R_InstantiateDockEventArgs args)
        {
            args.TargetPageType = typeof(SAB02003);
        }
    }
}
